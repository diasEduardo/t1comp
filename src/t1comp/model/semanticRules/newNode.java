...
public class newNode implements SemanticRule<Integer>{
    ...
    public Integer action() {
        ...
        if(ids.size() == 2){
            SemanticNode father = new SemanticNode(table.genId(),attributes.get(1),nodes.get(0));
            SemanticNode child = new SemanticNode(table.genId(),attributes.get(2),father);
            SemanticNode newNode = new SemanticNode(table.genId(),father,child,nodes.get(1).getAttributeValue(attributes.get(3)));
